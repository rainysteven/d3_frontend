...
(function (global, factory) {
  ...
  let d3__namespace = /*#__PURE__*/ _interopNamespace(d3);
  ...
  function forceInABox() {
    ...
    let id = index,
      ...
      tree,
      size = [100, 100],
      forceNodeSize = constant(
        1), // The expected node size used for computing the cluster node
